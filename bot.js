...
bot.on("message", (msg) => {
   ...
   if (msg.content === "databoss"){
         ...
         var boss06 = "06.00   "+"`"+databoss.day1.b06[0]+"`  "+"`"+databoss.day2.b06[0]+"`  "+"`"+databoss.day3.b06[0]+"`  "+"`"+databoss.day4.b06[0]+"`  "+"`"+databoss.day5.b06[0]+"`  "+"`"+databoss.day6.b06[0]+"`  "+"`"+databoss.day0.b06[0]+"`  "
         var boss10 = "10.00   "+"`"+databoss.day1.b10[0]+"`  "+"`"+databoss.day2.b10[0]+"`  "+"`"+databoss.day3.b10[0]+"`  "+"`"+databoss.day4.b10[0]+"`  "+"`"+databoss.day5.b10[0]+"`  "+"`"+databoss.day6.b10[0]+"`  "+"`"+databoss.day0.b10[0]+"`  "
         var boss14 = "14.00   "+"`"+databoss.day1.b14[0]+"`  "+"`"+databoss.day2.b14[0]+"`  "+"`"+databoss.day3.b14[0]+"`  "+"`"+databoss.day4.b14[0]+"`  "+"`"+databoss.day5.b14[0]+"`  "+"`"+databoss.day6.b14[0]+"`  "+"`"+databoss.day0.b14[0]+"`  "
         var boss19 = "19.00   "+"`"+databoss.day1.b19[0]+"`  "+"`"+databoss.day2.b19[0]+"`  "+"`"+databoss.day3.b19[0]+"`  "+"`"+databoss.day4.b19[0]+"`  "+"`"+databoss.day5.b19[0]+"`  "+"`"+databoss.day6.b19[0]+"`  "+"`"+databoss.day0.b19[0]+"`  "
         var boss23 = "23.00   "+"`"+databoss.day1.b23[0]+"`  "+"`"+databoss.day2.b23[0]+"`  "+"`"+databoss.day3.b23[0]+"`  "+"`"+databoss.day4.b23[0]+"`  "+"`"+databoss.day5.b23[0]+"`  "+"`"+databoss.day6.b23[0]+"`  "+"`"+databoss.day0.b23[0]+"`  "
